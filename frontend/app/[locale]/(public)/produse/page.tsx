...
export default async function ArchivePage({ params, searchParams }: ArchivePageProps) {
    ...
    const inStockParam = getParam(['inStock']);
            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <aside className="w-full lg:w-64 flex-shrink-0">
                        <ProductFilter categories={categories} filters={filters} total={pageInfo?.total} selectedCategory={category} inStockDefault={inStockParam !== 'false'} />
                    </aside>
