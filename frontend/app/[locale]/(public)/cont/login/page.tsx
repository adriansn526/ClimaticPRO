    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (email.includes('installer')) {
                ...
                // Default to admin for easier dev, since 'admin' is typically what adrian tests as.
            ...
            posthog.identify(email, { email, name: mockUser.name, role: mockUser.roles[0] });
            posthog.capture('user_signed_in', { email, role: mockUser.roles[0] });
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-gray-600">
                    Sau{' '}
                    <Link href="/cont/inregistrare" className="font-medium text-orange-600 hover:text-orange-500">
                        creează un cont nou
                    </Link>
                </p>
            </div>
